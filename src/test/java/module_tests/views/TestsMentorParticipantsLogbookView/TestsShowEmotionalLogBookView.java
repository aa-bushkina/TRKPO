...
public class TestsShowEmotionalLogBookView {
    ...
    /**
     * Проверяем работу showEmotionalLogBookView
     */
    @Test
    void testShowEmotionalLogBookView() throws Exception {
        ...
        Field field1 = c.getDeclaredField("emotionalDesc");
        field1.setAccessible(true);
        TextArea emotionalDesc = (TextArea) field1.get(mentorParticipantsLogbookView);
