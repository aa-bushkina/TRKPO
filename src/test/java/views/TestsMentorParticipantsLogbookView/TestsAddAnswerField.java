...
public class TestsAddAnswerField {
    ...
    void testAddAnswerField() throws Exception {
        ...
        Method method = c.getDeclaredMethod("addAnswerField", String.class);
        method.setAccessible(true);
        method.invoke(mentorParticipantsLogbookView, str);
        Field field = c.getDeclaredField("answerField");
        field.setAccessible(true);
        TextArea answerField = (TextArea) field.get(mentorParticipantsLogbookView);
        assertEquals("Ваш ответ", answerField.getLabel());
