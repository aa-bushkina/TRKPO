package module.views.TestsParticipantSignUp3View;
...
public class TestsSubmitBtnInit {
    ...
    /**
     * Тест для метода submitBtnInit.
     * Проверяет, что кнопка "Завершить" правильно инициализирована.
     */
    @Test
    void testSubmitBtnInit() throws Exception {
        Class cl = ParticipantSignUp3View.class;
        Method method = cl.getDeclaredMethod("submitBtnInit");
